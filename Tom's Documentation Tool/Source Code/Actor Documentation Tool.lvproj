...
<Project Type="Project" LVVersion="15008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Provider Support" Type="Folder">
			...
			<Item Name="Documentation Tool.png" Type="Document" URL="../Provider Tools/Documentation Tool.png"/>
			<Item Name="TomsToolsDocumentationTool.ini" Type="Document" URL="../Provider Tools/TomsToolsDocumentationTool.ini"/>
			<Item Name="TomsToolsDocumentationTool_Global_Init.vi" Type="VI" URL="../Provider Tools/TomsToolsDocumentationTool_Global_Init.vi"/>
			<Item Name="TomsToolsDocumentationTool_Global_Interface.vi" Type="VI" URL="../Provider Tools/TomsToolsDocumentationTool_Global_Interface.vi"/>
			<Item Name="TomsToolsDocumentationTool_Global_OnCommand.vi" Type="VI" URL="../Provider Tools/TomsToolsDocumentationTool_Global_OnCommand.vi"/>
			<Item Name="TomsToolsDocumentationTool_Item_Init.vi" Type="VI" URL="../Provider Tools/TomsToolsDocumentationTool_Item_Init.vi"/>
			<Item Name="TomsToolsDocumentationTool_Item_Interface.vi" Type="VI" URL="../Provider Tools/TomsToolsDocumentationTool_Item_Interface.vi"/>
			<Item Name="TomsToolsDocumentationTool_Item_OnCommand.vi" Type="VI" URL="../Provider Tools/TomsToolsDocumentationTool_Item_OnCommand.vi"/>
			<Item Name="TomsToolsDocumentationTool_Item_OnPopupMenu.vi" Type="VI" URL="../Provider Tools/TomsToolsDocumentationTool_Item_OnPopupMenu.vi"/>
			<Item Name="TomsToolsDocumentationTool_Provider_InitItems.vi" Type="VI" URL="../Provider Tools/TomsToolsDocumentationTool_Provider_InitItems.vi"/>
			<Item Name="TomsToolsDocumentationTool_Provider_Interface.vi" Type="VI" URL="../Provider Tools/TomsToolsDocumentationTool_Provider_Interface.vi"/>
			<Item Name="TomsToolsDocumentationTool_Provider_OnCommand.vi" Type="VI" URL="../Provider Tools/TomsToolsDocumentationTool_Provider_OnCommand.vi"/>
			<Item Name="TomsToolsDocumentationTool_Provider_OnPopupMenu.vi" Type="VI" URL="../Provider Tools/TomsToolsDocumentationTool_Provider_OnPopupMenu.vi"/>
		</Item>
